...
class DepartmentBuilder(ComponentBuilder):
    component_folder = "departments"
    component_label = "Departamento"
    ...
    def build(self, component_name: str) -> Path:
        ...
        try:
            template = self.resolver.resolve("department", self.template_selection)
